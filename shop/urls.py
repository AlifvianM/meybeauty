...
urlpatterns= [
	...
	path('orderdetail/<str:kode_nota>', orderdetail, name='shop-orderdetail'),
	path('transaction/', transaction, name = 'shop-transaction'),
	path('bayar/<str:kode_nota>', OrderBayarUpdate, name='shop-bayar'),
	...
	path('CheckOut/<str:kode_nota>', orderupdate, name='shop-checkout'),
	path('homecheck/<int:orderkode_id>', orderitem_update, name='shop-homecheck'),
	# path('CheckOut/<str:_nota>', pembayarancreate, name='shop-checkout'),
